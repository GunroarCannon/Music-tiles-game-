class GameScene extends Phaser.Scene {
    ...
    constructor(data) {
        ...
        this.NUM_LANES = 4;
        this.LANE_WIDTH = 0;
        this.LANE_COLORS = [0xcbeaff]; // Nigerian Green (moderately saturated)
        this.NOTE_COLOR = 0x000000;
        this.NOTE_SPEED = 500+2000; // Faster speed
    ...
    preload() {
        this.load.json('beatmap', this.data.beatmapPath);console.log("beat");
        this.load.audio('music', this.data.musicPath);
        console.log("music");
    }
    ...
    createLanes() {
        for (let i = 0; i < this.NUM_LANES; i++) { console.log("laning",i);
            this.add.rectangle(
